...
class Sensor(SensorProtocol, Device):
    ...
    def to_serializable(self) -> SerializableProtocol:
        return SensorDto(
            ...
            value_ma=self.value_ma,
            alarm_start_delay=int(self.alarm_start_delay),
            alarm_stop_delay=int(self.alarm_stop_delay),
            alarm_start_high=self.alarm_start_high,
            alarm_stop_high=self.alarm_stop_high,
            alarm_start_high_high=self.alarm_start_high_high,
            alarm_stop_high_high=self.alarm_stop_high_high,
            ai_max=self.ai_max,
            ai_min=self.ai_min,
            device_id=self.device_id,
            device_name=self.device_name,
            value_ai=self.ai,
            value_scaled_max=self.value_scaled_max,
            value_scaled_min=self.value_scaled_min,
